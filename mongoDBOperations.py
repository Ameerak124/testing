...
class MongoDBManagement:
    ...
    def __init__(self, username, password):
        ...
        try:
            ...
            print(f"Object created {self.username} {self.password }")
    ...
    def getMongoDBClientObject(self):
        ...
        try:
            ...
            print(f"mongo_client created {self.username} {self.password } {self.url}")
    ...
    def createDatabase(self, db_name):
        ...
        try:
            ...
            print(f"database_check_status = {database_check_status}")
            if (database_check_status == False):
                ...
                database = mongo_client[db_name]
                mongo_client.close()
                print(f"DB {db_name} is already present")
                return database
        except Exception as e:
    ...
    def createCollection(self, collection_name, db_name):
        ...
        try:
            ...
            if (collection_check_status == False):
                ...
                print(f"Collection Already present {collection_name}")
